...
//
//
// SimpleOpenGLQtViewer : Class to provide Qt specific
...
//////////////////////////////////////////////////////////////////////////////
void SimpleOpenGLQtViewer::CreateMainWindow (
        QGLWidget* glWidget
        ,const QString& name
        )
//////////////////////////////////////////////////////////////////////////////
    ...
    if ( fUiQt) {
        Q_FOREACH (QWidget *widget, QApplication::allWidgets()) {
            if ((widget->inherits("QMainWindow"))) {
                if(widget->windowTitle().contains("Simple")){
                    QList<QVBoxLayout *> layouts = widget->findChildren<QVBoxLayout *>("viewerLayout");
                    if(layouts.count()>0){
                        QVBoxLayout* layout = layouts.at(0);
...
//////////////////////////////////////////////////////////////////////////////
SimpleOpenGLQtViewer::SimpleOpenGLQtViewer (
...
//
void SimpleOpenGLQtViewer::createPopupMenu()    {
...
void SimpleOpenGLQtViewer::G4manageContextMenuEvent(QContextMenuEvent *e)
{
    if (!fGLWidget) {
...
*/
void SimpleOpenGLQtViewer::createRadioAction(QAction *action1,QAction *action2, const std::string& method,unsigned int nCheck) {
...
*/
void SimpleOpenGLQtViewer::showShortcuts() {
    G4String text;
...
*/
void SimpleOpenGLQtViewer::toggleMouseAction(int aAction) {
...
/**
   ...
   @see G4XXXStoredViewer::CompareForKernelVisit
*/
void SimpleOpenGLQtViewer::toggleSurfaceAction(int aAction) {
...
/**
   ...
   @see G4XXXStoredViewer::CompareForKernelVisit
*/
void SimpleOpenGLQtViewer::toggleProjection(bool check) {
...
/**
   ...
   @param check : 1 , 0
*/
void SimpleOpenGLQtViewer::toggleTransparency(bool check) {
...
/**
   ...
   @param check : 1 , 0
*/
void SimpleOpenGLQtViewer::toggleAntialiasing(bool check) {
...
*/
//FIXME : I SEE NOTHING...
void SimpleOpenGLQtViewer::toggleHaloing(bool check) {
    if (check) {
...
/**
   ...
   @param check : 1 , 0
*/
void SimpleOpenGLQtViewer::toggleAux(bool check) {
    if (check) {
...
void SimpleOpenGLQtViewer::togglePicking() {
...
/**
   ...
   @param check : 1 , 0
*/
void SimpleOpenGLQtViewer::toggleHiddenMarkers(bool check) {
    if (check) {
        fVP.SetMarkerHidden();
    } else {
...
*/
void SimpleOpenGLQtViewer::toggleFullScreen(bool check) {
...
void SimpleOpenGLQtViewer::savePPMToTemp() {
...
void SimpleOpenGLQtViewer::actionSaveImage() {
    QString filters;
...
void SimpleOpenGLQtViewer::actionChangeBackgroundColor() {
...
void SimpleOpenGLQtViewer::actionChangeTextColor() {
...
void SimpleOpenGLQtViewer::actionChangeDefaultColor() {
...
void SimpleOpenGLQtViewer::actionMovieParameters() {
    showMovieParametersDialog();
}


void SimpleOpenGLQtViewer::showMovieParametersDialog() {
...
void SimpleOpenGLQtViewer::FinishView()
{
    /* From Apple doc:
...
*/
void SimpleOpenGLQtViewer::G4MousePressEvent(QMouseEvent *evnt)
{
...
/**
 */
void SimpleOpenGLQtViewer::G4MouseReleaseEvent(QMouseEvent *evnt)
{
    GLint viewport[4];
...
void SimpleOpenGLQtViewer::G4MouseDoubleClickEvent()
{
    fGLWidget->setMouseTracking(true);
}
...
void SimpleOpenGLQtViewer::G4MouseMoveEvent(QMouseEvent *evnt)
{
...
void SimpleOpenGLQtViewer::moveScene(float dx,float dy, float dz,bool mouseMove)
{
    if (fHoldMoveEvent)
        return;
    fHoldMoveEvent = true;
...
void SimpleOpenGLQtViewer::rotateQtScene(float dx, float dy)
{
    if (fHoldRotateEvent)
        return;
...
void SimpleOpenGLQtViewer::rotateQtSceneToggle(float dx, float dy)
{
    if (fHoldRotateEvent)
        return;
    fHoldRotateEvent = true;
...
*/
void SimpleOpenGLQtViewer::rescaleImage(
        int /* aWidth */
        ,int /* aHeight */
        ){
...
void SimpleOpenGLQtViewer::G4wheelEvent (QWheelEvent * evnt)
{
...
void SimpleOpenGLQtViewer::G4keyPressEvent (QKeyEvent * evnt)
{
    if (fHoldKeyEvent)
        return;
...
void SimpleOpenGLQtViewer::G4keyReleaseEvent (QKeyEvent *)
{
    fGLWidget->setCursor(QCursor(Qt::ArrowCursor));
}


void  SimpleOpenGLQtViewer::updateKeyModifierState(const Qt::KeyboardModifiers& modifier) {
    // Check Qt Versions for META Keys
 ...
 */
void SimpleOpenGLQtViewer::stopVideo() {
...
/** Stop the video. Check all parameters and enable encoder button if all is ok.
 */
void SimpleOpenGLQtViewer::saveVideo() {
 ...
 */
void SimpleOpenGLQtViewer::startPauseVideo() {
...
void SimpleOpenGLQtViewer::setRecordingStatus(RECORDING_STEP step) {
...
void SimpleOpenGLQtViewer::displayRecordingStatus() {
...
void SimpleOpenGLQtViewer::setRecordingInfos(const QString& txt) {
    if (fMovieParametersDialog) {
 ...
 */
void SimpleOpenGLQtViewer::initMovieParameters() {
    //init encoder
 ...
 */
QString SimpleOpenGLQtViewer::getEncoderPath() {
    return fEncoderPath;
}
 ...
 */
QString SimpleOpenGLQtViewer::setEncoderPath(QString path) {
    if (path == "") {
...
bool SimpleOpenGLQtViewer::isRecording(){
...
bool SimpleOpenGLQtViewer::isPaused(){
...
bool SimpleOpenGLQtViewer::isEncoding(){
...
bool SimpleOpenGLQtViewer::isWaiting(){
    if (fRecordingStep == WAIT) {
        return true;
    }
    return false;
...
bool SimpleOpenGLQtViewer::isStopped(){
    if (fRecordingStep == STOP) {
        return true;
    }
    return false;
...
bool SimpleOpenGLQtViewer::isFailed(){
...
bool SimpleOpenGLQtViewer::isSuccess(){
...
bool SimpleOpenGLQtViewer::isBadEncoder(){
    if (fRecordingStep == BAD_ENCODER) {
        return true;
    }
    return false;
}
bool SimpleOpenGLQtViewer::isBadTmp(){
    if (fRecordingStep == BAD_TMP) {
        return true;
    }
    return false;
}
bool SimpleOpenGLQtViewer::isBadOutput(){
...
void SimpleOpenGLQtViewer::setBadEncoder(){
    fRecordingStep = BAD_ENCODER;
    displayRecordingStatus();
}
void SimpleOpenGLQtViewer::setBadTmp(){
    fRecordingStep = BAD_TMP;
    displayRecordingStatus();
}
void SimpleOpenGLQtViewer::setBadOutput(){
    fRecordingStep = BAD_OUTPUT;
    displayRecordingStatus();
}

void SimpleOpenGLQtViewer::setWaiting(){
    fRecordingStep = WAIT;
    displayRecordingStatus();
}


bool SimpleOpenGLQtViewer::isReadyToEncode(){
...
void SimpleOpenGLQtViewer::resetRecording() {
 ...
 * @return "" if correct. The error otherwise
 */
QString SimpleOpenGLQtViewer::setTempFolderPath(QString path) {
 ...
 */
QString SimpleOpenGLQtViewer::getTempFolderPath() {
 ...
 * @return "" if correct. The error otherwise
 */
QString SimpleOpenGLQtViewer::setSaveFileName(QString path) {
 ...
 */
QString SimpleOpenGLQtViewer::getSaveFileName() {
 ...
 */
QString SimpleOpenGLQtViewer::createTempFolder() {
    fMovieTempFolderPath = "";
    //check
 ...
 */
QString SimpleOpenGLQtViewer::removeTempFolder() {
 ...
 */
bool SimpleOpenGLQtViewer::exportImage(std::string name, int width, int height) {
...
bool SimpleOpenGLQtViewer::hasPendingEvents () {
    return ((QApplication*)G4Qt::getInstance ())->hasPendingEvents ();
}

bool SimpleOpenGLQtViewer::generateMpegEncoderParameters () {
...
void SimpleOpenGLQtViewer::encodeVideo()
{
...
void SimpleOpenGLQtViewer::processEncodeStdout()
{
...
void SimpleOpenGLQtViewer::processEncodeFinished()
{
...
void SimpleOpenGLQtViewer::processLookForFinished()
{
...
QString SimpleOpenGLQtViewer::getProcessErrorMsg()
{
    QString txt = "";
...
QWidget *SimpleOpenGLQtViewer::getParentWidget()
{
    // launch Qt if not
    G4Qt* interactorManager = G4Qt::getInstance ();
    // G4UImanager* UI =
...
void SimpleOpenGLQtViewer::createSceneTreeWidget() {
   // fUISceneTreeWidget = fUiQt->GetSceneTreeWidget();

//    if (!fUISceneTreeWidget) {
//        qDebug()<<"No scene tree widget found...";
//        return;
//    }
    ...
    Q_FOREACH (QWidget *widget, QApplication::allWidgets()) {
        if ((widget->inherits("QMainWindow"))) {
            if(widget->windowTitle().contains("Simple")){
                QList<QTabWidget *> w = widget->findChildren<QTabWidget *>("sceneTreeWidget");
                if(w.count()>0){
                    fUISceneTreeWidget = w.at(0)->widget(2);
                     qDebug()<<"scene tree tab widget found...";
                    //createSceneTreeWidget();
                    //return;
                }
            }
...
//        if ((widget->inherits("QMainWindow"))) {
//            if(widget->windowTitle().contains("Simple")){
//                QList<QWidget *> w = widget->findChildren<QWidget *>("fSceneTreeWidget");
//                if(w.count()>0){
//                    fSceneTreeWidget = w.at(0);
//                     qDebug()<<"scene tree widget found...";
//                    //createSceneTreeWidget();
//                    //return;
//                }
//            }
...
//    }
    ...
    if (!found) {
        ...
        if (dynamic_cast<SimpleOpenGLStoredQtViewer*> (this))
        {
...
void SimpleOpenGLQtViewer::createSceneTreeComponent(){
...
void SimpleOpenGLQtViewer::createViewerPropertiesWidget() {
...
void SimpleOpenGLQtViewer::createPickInfosWidget(){
...
void SimpleOpenGLQtViewer::setCheckComponent(QTreeWidgetItem* item,bool check)
{
    if (item) {
...
void SimpleOpenGLQtViewer::DrawText(const G4Text& g4text)
{
    QGLWidget* qGLW = dynamic_cast<QGLWidget*> (fGLWidget) ;
    if (! qGLW) {
        return;
...
void SimpleOpenGLQtViewer::ResetView () {
...
void SimpleOpenGLQtViewer::addPVSceneTreeElement(const G4String& model, G4PhysicalVolumeModel* pPVModel, int currentPOIndex) {
...
*/
QTreeWidgetItem* SimpleOpenGLQtViewer::createTreeWidgetItem(
...
//
bool SimpleOpenGLQtViewer::parseAndInsertInSceneTree(
...
void SimpleOpenGLQtViewer::changeOpenCloseVisibleHiddenSelectedColorSceneTreeElement(
...
bool SimpleOpenGLQtViewer::isSameSceneTreeElement(
...
void SimpleOpenGLQtViewer::addNonPVSceneTreeElement(
...
*/
QString SimpleOpenGLQtViewer::getModelShortName(const G4String& model) {
...
bool SimpleOpenGLQtViewer::isTouchableVisible(int POindex){
...
bool SimpleOpenGLQtViewer::parseAndCheckVisibility(QTreeWidgetItem * treeNode,int POindex){
    bool isFound = false;
...
std::string SimpleOpenGLQtViewer::parseSceneTreeAndSaveState(){
...
std::string SimpleOpenGLQtViewer::parseSceneTreeElementAndSaveState(QTreeWidgetItem* item, unsigned int level){
    // parse current item
...
void SimpleOpenGLQtViewer::sceneTreeComponentItemChanged(QTreeWidgetItem* item, int) {
...
void SimpleOpenGLQtViewer::sceneTreeComponentSelected() {
}

void SimpleOpenGLQtViewer::changeDepthInSceneTree (int val){
...
void SimpleOpenGLQtViewer::changeColorAndTransparency(QTreeWidgetItem* item,int) {
...
void SimpleOpenGLQtViewer::changeColorAndTransparency(GLuint index, G4Color color) {
...
G4Colour SimpleOpenGLQtViewer::getColorForPoIndex(int poIndex) {
...
SimpleOpenGLQtViewer::GetPrivateVisAttributesModifiers() const
{
...
void SimpleOpenGLQtViewer::changeSearchSelection()
{
...
void SimpleOpenGLQtViewer::clearSceneTreeSelection(QTreeWidgetItem* item) {
...
bool SimpleOpenGLQtViewer::isPVVolume(QTreeWidgetItem* item) {
...
void SimpleOpenGLQtViewer::changeDepthOnSceneTreeItem(
        double lookForDepth
        ,double currentDepth
...
void SimpleOpenGLQtViewer::clearTreeWidget(){
...
/**
   ...
   - Selected
*/
QTreeWidgetItem * SimpleOpenGLQtViewer::cloneWidgetItem(QTreeWidgetItem* item) {
...
*/
void SimpleOpenGLQtViewer::cloneSceneTree(
...
*/
void SimpleOpenGLQtViewer::updatePositivePoIndexSceneTreeWidgetQuickMap(int POindex,QTreeWidgetItem* item) {
...
void SimpleOpenGLQtViewer::changeQColorForTreeWidgetItem(QTreeWidgetItem* item,const QColor& qc) {
 ...
 */
QTreeWidgetItem* SimpleOpenGLQtViewer::getTreeWidgetItem(int POindex){
 ...
 */
QTreeWidgetItem* SimpleOpenGLQtViewer::getOldTreeWidgetItem(int POindex){
...
/**
   ...
   and update tree
*/
void SimpleOpenGLQtViewer::displaySceneTreeComponent() {
    // no UI
    if (fUISceneTreeWidget == NULL) {
        return;
    }
...
/**
   ...
   - Change cursor style
 */
void SimpleOpenGLQtViewer::updateToolbarAndMouseContextMenu(){
    if (fBatchMode) {
        return;
    }
 ...
 */
void SimpleOpenGLQtViewer::updateSceneTreeWidget() {
 ...
 */
void SimpleOpenGLQtViewer::updateViewerPropertiesTableWidget() {
 ...
 */
void SimpleOpenGLQtViewer::updatePickInfosWidget(int aX, int aY) {
...
void SimpleOpenGLQtViewer::toggleSceneTreeComponentPickingCout(int pickItem) {
...
void SimpleOpenGLQtViewer::currentTabActivated(int currentTab) {
...
void SimpleOpenGLQtViewer::tableWidgetViewerSetItemChanged(QTableWidgetItem * item) {
    G4UImanager* UI = G4UImanager::GetUIpointer();
    if(UI != NULL)  {
...
bool SimpleOpenGLQtViewer::isCurrentWidget(){
    G4Qt* interactorManager = G4Qt::getInstance ();
    if (!interactorManager->IsExternalApp()) {
 ...
 */
QString SimpleOpenGLQtViewer::GetCommandParameterList (
...
void SimpleOpenGLQtViewer::DoneWithMasterThread()
{
...
void SimpleOpenGLQtViewer::SwitchToVisSubThread()
{
...
void SimpleOpenGLQtViewer::DoneWithVisSubThread()
{
...
void SimpleOpenGLQtViewer::SwitchToMasterThread()
{
    // Called by VisSub Thread !
...
void SimpleOpenGLQtViewer::MovingToVisSubThread(){
    // Called by Main Thread !
