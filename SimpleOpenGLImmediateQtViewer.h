...
//
//
// Class SimpleOpenGLImmediateQtViewer : a class derived from
...
class SimpleOpenGLImmediateQtViewer:
  public SimpleOpenGLQtViewer, public G4OpenGLImmediateViewer, public QGLWidget {


public:
  SimpleOpenGLImmediateQtViewer (G4OpenGLImmediateSceneHandler& scene,
                const G4String& name = "");
  ~SimpleOpenGLImmediateQtViewer ();
  void Initialise ();
  void initializeGL ();
  void DrawView ();
