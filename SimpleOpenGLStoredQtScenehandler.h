...
class SimpleOpenGLStoredQtSceneHandler: public G4OpenGLStoredSceneHandler {

public:

  SimpleOpenGLStoredQtSceneHandler (G4VGraphicsSystem& system, const G4String& name = "");
  virtual ~SimpleOpenGLStoredQtSceneHandler ();
...
#endif // SIMPLEOPENGLSTOREDQTSCENEHANDLER_H
