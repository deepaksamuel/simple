...
class SimpleOpenGLQtViewer: public QObject, virtual public G4OpenGLViewer {
...
public:
  SimpleOpenGLQtViewer (G4OpenGLSceneHandler& scene);
  virtual ~SimpleOpenGLQtViewer ();
...
private:
  SimpleOpenGLQtViewer (const SimpleOpenGLQtViewer&);
  SimpleOpenGLQtViewer& operator= (const SimpleOpenGLQtViewer&);
public:
